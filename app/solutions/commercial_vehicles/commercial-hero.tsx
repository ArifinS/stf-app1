...
const slides = [
  ...
  {
    id: 2,
    title: "Fleet Management Efficiency",
...
export default function CommercialHero() {
  ...
  return (
    <section className="relative h-[800px]  md:h-[700px] w-full overflow-hidden">
      {/* Background Slides */}
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="max-w-2xl">
            ...
            <motion.h1
              ...
              className="text-3xl sm:text-4xl text-black lg:text-5xl font-bold mb-6"
            >
